...
function Close-Open-Windows() {
    ...
    (Get-Process | Where-Object { $_.mainwindowtitle -ne "" -and $_.processname -ne "console" -and $_.processname -ne "powershell" -and $_.processname -ne "devenv" -and $_.processname -ne "WindowsTerminal" } ) | Stop-Process -ErrorAction Ignore
